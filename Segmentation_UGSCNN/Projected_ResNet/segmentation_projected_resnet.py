...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb  9 21:44:31 2021
...
from MyDataLoader import My_Projected_dHCP_Data_Segmentation
...
def main():
    ...
    MyTrainLoader  = DataLoader(train_loader,batch_size=1, shuffle=True, num_workers=4)
    ...
    for epoch in range(numberOfEpochs):
        ...
        if epoch%1 ==0:
            with torch.no_grad():
                ...
                if val_loss < best:
                    best = val_loss
                    torch.save(model, '/home/lw19/Desktop/final_benchmarking_models/best_Projected_UNet_Native_warp_rot')
                    patience = 0
    ...
    torch.save(model, '/home/lw19/Desktop/final_benchmarking_models/final_Projected_UNet_Native_warp_rot')
    print('saved_final_model')
    test_loss = []
    model.eval()
    for i, batch in enumerate(MyTestLoader):
        ...
        loss = 1-dice_coeff(estimates,test_label)
