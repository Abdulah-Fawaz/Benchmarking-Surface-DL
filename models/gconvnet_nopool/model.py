...
class gconvnet_nopool_classification(nn.Module):

    def __init__(self, num_features, conv_style=gcnconv,activation_function=nn.ReLU(), in_channels = 9, device='cuda'):
        super(gconvnet_nopool_classification, self).__init__()
        self.conv_style = conv_style
        self.device = device
        self.in_channels = 9
        self.conv1 = conv_style(self.in_channels, num_features[0])
