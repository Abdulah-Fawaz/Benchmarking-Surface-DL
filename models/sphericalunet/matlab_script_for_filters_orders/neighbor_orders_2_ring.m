...
for i = 1:40962
    for j = 1:6
        delete_neigh = adj_mat_40962(i,j);
        if delete_neigh == 0
            new_neigh = i;
            adj_mat_40962(i,j) = new_neigh;
        end
%         else
%             neigh_of_delete_neigh = adj_mat_40962(delete_neigh, :);
%             for k = 1:6
...
save(strcat('/home/fa19/Documents/my_version_spherical_unet/neighbour_indices_matlab', '/adj_mat_order_2ring_40962.mat'), 'adj_mat_order_2ring'); 
...
for n = 1:length(nums)
    ...
    save(strcat('/home/fa19/Documents/my_version_spherical_unet/neighbour_indices_matlab', '/adj_mat_order_2ring_' , num2str(num), '.mat'), 'adj_mat_order_2ring'); 
